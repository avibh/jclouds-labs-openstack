...
import org.jclouds.openstack.ceilometer.v2.binders.BindQueryRequestPayload;
...
public interface QueryApi {
   ...
   @Produces(MediaType.APPLICATION_JSON)
   @Fallback(EmptyListOnNotFoundOr404.class)
   @MapBinder(BindQueryRequestPayload.class)
   List<Sample> listSamples(@Nullable @PayloadParam("options") ComplexQueryOptions options);
